...
**BIO-8c inject**: 詳述 `[somatic_state]` は異常時のみ（正常は要約行 `somatic=ok`）→ [inject-surface-layers.md](./inject-surface-layers.md)。  
**対人・予定版**（証拠ギャップ → concern → 確認）→ [tracks/spontaneity.md](../tracks/spontaneity.md) § B 軸。  
詳細は [archive/backlog-ma-home-full-2026-06-26.md](../archive/backlog-ma-home-full-2026-06-26.md) の BIO-8 節。
...
| BIO-8d | Somatic — 複数器官 escalation | **済**（push 原文は compose demote · Dreaming LTM Skip） |
...
**次トラック（合意 2026-06-18）**: **MEM**（セッション跨ぎ・Dreaming）。詳細 → [archive/backlog-ma-home-full-2026-06-26.md](../archive/backlog-ma-home-full-2026-06-26.md) MEM 節。進行中は [tracks/alive-lw-read.md](../tracks/alive-lw-read.md)。
