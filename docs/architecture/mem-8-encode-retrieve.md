...
→ **8a** 多視点 fact 行、**8b** query 整形、**8e** `[person_profile_gists]`（暫定 L0 · **cue 時のみ表層注入** 2026-07-18）、**8d** L0/L2 整理。
...
会話で過去を使う経路の比喩。**今の会話の向き**に合う **短いカード**を材料として辿る（KJ 短冊 / [spontaneity § 思考](../tracks/spontaneity.md#思考プロセス仮説--kj-法的な短文のつなぎまー-2026-07-17)）。

- **やる**: encode で日付付き短冊 · retrieve で向き合わせ · 表層はつなぎだけ
- **やらない**: 会話全文の辺ネットワーク · 因果自動構築（上表）
- **会話の第一ノード**: 食事記録カード → [mem-8h](../tracks/mem-8h-memory-bridge.md)
...
| **MEM-8j** | 身の回り固有名のエンティティ属性マップ（所在地・カテゴリ・関係性。例: ねっとわん⇔松本）。gist 散文の構造化先。Brief S0 地域推論などはこれ前提 | **💤 覚書**（2026-07-21 · backlog） |
