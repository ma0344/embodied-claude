...
| **wifi-cam-mcp（ma-home 直 ONVIF）** | **JPEG は動く**（2026-06-20 プローブ） | RelativeMove 成功・**GetStatus は更新されないことがある** |
...
| **CAM-3** | **ドキュメント** — FAQ 4465 リンク + DS Cam OK / SS Web NG / GetStatus 注意（CLAUDE.md / wifi-cam README） | 未 |

**関連**: [TP-Link FAQ 4465](https://www.tp-link.com/jp/support/faq/4465/)、`wifi-cam-mcp/scripts/test_ptz_probe.py`、`presence-ui` `look_preset_direct`、Imou は `continuous` 必須（CLAUDE.md）
