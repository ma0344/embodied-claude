...
2. 画面を **1回タップ**（ブラウザ音声の解除）
3. `restart-presence-ui.ps1` 済み、**Claude Code / MCP を再起動**（tts-mcp の kiosk ルーティング反映）
4. 診断: `curl -s http://127.0.0.1:8090/api/v1/ui-config | jq .kiosk_primary_active` → **true**
