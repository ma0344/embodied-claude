...
echo "  docs: scripts/koyori-kiosk/../docs/koyori-kiosk-browser.md"
echo "  KOYORI_FIREFOX_KIOSK_FLAG=0  # tab bar visible; use if --kiosk breaks display"
echo "  KOYORI_FIREFOX_KIOSK_FLAG=1  # default after install"
